...
def ensure_permissions() -> None:
    ...
    if not accessibility_permissions:
        ...
        info = "To let TimeBench capture window titles grant it accessibility permissions. \n If you've already given TimeBench accessibility permissions and are still seeing this dialog, try removing and re-adding them."
